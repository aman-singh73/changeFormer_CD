...
if __name__ == '__main__':
    parser = ArgumentParser(description="Enhanced ChangeFormer Training for Extreme Class Imbalance")
    ...
    parser.add_argument('--exp_name', type=str, default='ChangeFormerV6_Enhanced_ClassBalance')
    ...
    parser.add_argument('--checkpoint_dir', type=str, 
                       default='./checkpoints/ChangeFormer_myCustom/ChangeFormerV6_Enhanced_ClassBalance')
    ...
    parser.add_argument('--pretrain_path', type=str, 
                       default=r'D:\Aman_kr_Singh\NEW_OSCD\ChangeFormer\checkpoints\ChangeFormer_LEVIR\ChangeFormerV6_LEVIR\LEVIR_EMPTY\best_ckpt.pt')
    ...
    print("ENHANCED CHANGEFORMER FOR EXTREME CLASS IMBALANCE")
    print("=" * 80)
    print("KEY IMPROVEMENTS FOR CLASS IMBALANCE:")
