...
class InMemoryAugmentedDataset(torch.utils.data.Dataset):
    ...
    def __getitem__(self, idx):
        ...
        try:
            ...
            dummy_img = torch.zeros(self.n_bands, 256, 256).float()
...
# Rest of the classes remain the same (ImprovedPostProcessor, FocalTverskyLoss, etc.)
# ... (keeping all other classes as they were) ...
